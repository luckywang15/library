...
<div style="height:100%;">
 ...
 <li><a href="exportbooks.php" target="rightFrame">书目数据导出</a></li>
 </ul>
 </li>
 ...
 <li><a class="head">读者管理</a>
 <ul>
 <li><a href="reader.php" target="rightFrame">借书证管理</a></li>
 <li><a href="exportusers.php" target="rightFrame">借书证数据导出</a></li>
 </ul>
 </li>
 <li><a class="head">借阅管理</a>
 <ul>
 <li><a href="lendout.php" target="rightFrame">借阅记录</a></li>
 <li><a href="lendoutselect.php" target="rightFrame">借阅查询</a></li>
 <li><a href="ajax.php" target="rightFrame">借阅动态</a></li>
 </ul>
 </li>
